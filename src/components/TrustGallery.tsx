...
const TRUST_ITEMS: GalleryItem[] = [
  {
    ...
    badgeDe: 'Gründerin',
    badgeEn: 'Founder',
    imageUrl: '/src/assets/images/founder_portrait_1784068713580.jpg',
  ...
  },
  {
    id: 'team-adenike',
    category: 'team',
    nameDe: 'Adenike Adeshina',
    nameEn: 'Adenike Adeshina',
    roleDe: 'Leiterin Alltagsbegleitung',
    roleEn: 'Head of Daily Support',
    shortDescDe: 'Führt unser Team für Alltagsbegleitung mit Professionalität, Herzlichkeit und einem hohen Anspruch an Qualität sowie persönlicher Betreuung.',
    shortDescEn: 'Leads our daily support team with professionalism, compassion and exceptional attention to every client.',
    longDescDe: 'Adenike leitet den Bereich für Alltagsbegleitung und Seniorenhilfe. Mit viel Geduld, Humor und Feingefühl begleitet sie Senioren zum Arzt, hilft bei Besorgungen oder führt tiefgründige Gespräche bei Spaziergängen in Pankow und Prenzlauer Berg.',
    longDescEn: 'Adenike leads the companionship and senior support department. With plenty of patience, humor and empathy, she accompanies seniors to medical visits, assists with errands, or holds deep conversations during walks in Berlin.',
    ...
    badgeEn: 'Care Expert',
    imageUrl: '/src/assets/images/adenike-adeshina.png',
  ...
  },
  {
    id: 'team-julia',
    category: 'team',
    nameDe: 'Julia Rozanski',
    nameEn: 'Julia Rozanski',
    roleDe: 'Leiterin Housekeeping',
    roleEn: 'Head of Customer Housekeeping',
    shortDescDe: 'Verantwortet sämtliche Housekeeping-Abläufe und gewährleistet höchste Qualitätsstandards sowie eine ausgezeichnete Betreuung unserer Kunden.',
    shortDescEn: 'Oversees all housekeeping operations, ensuring consistent service quality and client satisfaction.',
    longDescDe: 'Julia liebt Ordnung und absolute Detailgenauigkeit. Sie ist hervorragend geschult auf modernste Wischsysteme und besitzt tiefes Wissen zur Werterhaltung edler Werkstoffe wie Marmor, Echtholz und empfindlicher Armaturen.',
    longDescEn: 'Julia loves structure and absolute attention to detail. She is superbly trained in modern wiping systems and possesses deep knowledge on maintaining the value of noble materials like marble, genuine wood, and sensitive kitchen fittings.',
    ...
    badgeEn: 'Hygiene Pro',
    imageUrl: '/src/assets/images/julia-rozanski.png',
    tipDe: 'Julias Holz-Tipp: Echtholz-Parkett darf niemals nass, sondern immer nur nebelfeucht gewischt werden. Trocknen Sie empfindliche Kanten sofort ab, um Quellschäden zu meiden.',
    tipEn: 'Julia’s Wood Tip: Real wood parquet floors should never be wiped wet, but only damp (mist-wet). Dry off delicate edges immediately to avoid swelling.',
